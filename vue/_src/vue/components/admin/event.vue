                  ...
                  .input-field
                    label.c-select
                      select.c-select__item(name='from' v-model='event.from')
                        ...
                        option(value='mid_twenty') 20代中頃
                        option(value='late_twenty') 20代後半
                        option(value='early_thirty') 30代前半
                        option(value='mid_thirty') 30代中頃
                        option(value='late_thirty') 30代後半
                        option(value='early_fourty') 40代前半
                        option(value='mid_fourty') 40代中頃
                        option(value='late_fourty') 40代後半
                        option(value='early_fifty') 50代前半
                        option(value='mid_fifty') 50代中頃
                        option(value='late_fifty') 50代後半
                  p から
                  .input-field
                    label.c-select
